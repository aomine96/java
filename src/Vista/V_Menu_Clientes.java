 ...
 * @author Dani
 */
public class V_Menu_Clientes extends JFrame {
    ...
    JMenuItem item1, item2, item3, item4, item5, item6, item7, item8, item9, itemseries, itempeliculas;

    public V_Menu_Clientes() {
        menu();
    }

    public V_Menu_Clientes(JPanel panel, JMenuBar menubar, JMenu menu1, JMenu menu2, JMenu menu3, JMenu menu4, JMenuItem item1, JMenuItem item2, JMenuItem item3, JMenuItem item4, JMenuItem item5, JMenuItem item6, JMenuItem item7, JMenuItem item8, JMenuItem item9, JMenuItem itempeliculas, JMenuItem itemseries) {
        this.panel = panel;
        ...
        this.item8 = item8;
        this.item9 = item9;
        this.itempeliculas = itempeliculas;
    ...
    public JMenuItem getItemseries() {
        return itemseries;
    }

    public void setItemseries(JMenuItem itemseries) {
        this.itemseries = itemseries;
    }

    public JMenuItem getItempeliculas() {
        return itempeliculas;
    }

    public void setItempeliculas(JMenuItem itempeliculas) {
        this.itempeliculas = itempeliculas;
    }
