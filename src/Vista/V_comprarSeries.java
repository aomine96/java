 ...
 * @author Dani
 */
public class V_comprarSeries extends JFrame {

    //variables
    JPanel panel, panel2;
    JLabel precio, introduccion, titulo, nombre, apellidos, direccion, unidades, stock, peliculas;
    JTextField textomostrar, textotitulo, textoprecio, textostock, textonombre, textoapellidos, textodireccion, textounidades;
    JButton mostrar, comprar, salir;

    //constructor
    public V_comprarSeries() {
        menu();
    }

    public V_comprarSeries(JPanel panel, JTextField textomostrar, JTextField textotitulo, JTextField textoprecio, JTextField textostock, JTextField textonombre, JTextField textoapellidos, JTextField textodireccion, JTextField textounidades, JButton mostrar, JButton comprar, JButton salir) {
        this.panel = panel;
    ...
    public void menu() {
        ...
        introduccion.setText("Introduce  la serie:");
