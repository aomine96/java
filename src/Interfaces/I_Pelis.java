 ...
 * @author Dani
 */
public class I_Pelis extends javax.swing.JFrame {

    /**
     * Creates new form I_Pelis
     */
    public I_Pelis() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I_Pelis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
